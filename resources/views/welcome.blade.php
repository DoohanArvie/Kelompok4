...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="index.html">Marabunta Money</a></h1>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">FINANCIAL WEBSITE</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Marabunta Money is a user-friendly online platform designed to help individuals and businesses manage their finances efficiently.
                 ...
                 financial reports, and set personal or business financial goals.</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="{{ route('login') }}" class="btn btn-outline-white">Get started</a></p>
            </div>
