                            ...
                            <form action="{{ route('updateKaryawan', ['id' => $karyawan->id_karyawan]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gaji" id="gaji" class="form-control"
                                        required='required' placeholder="Masukkan Gaji Karyawan" value="{{ old('gaji', $karyawan->gaji) }}">
                                </div>
                                <div class="form-group">
                                    <label for="umur">Umur</label>
                                    <input type="number" name="umur" id="umur" class="form-control"
                                        required='required' placeholder="Masukkan Umur Karyawan" value="{{ old('umur', $karyawan->umur) }}">
                                </div>
                                <div class="form-group">
                                    <label for="kontak">Kontak</label>
                                    <input type="number" name="kontak" id="kontak" class="form-control"
                                        required='required' placeholder="Masukkan Kontak Karyawan" value="{{ old('kontak', $karyawan->kontak                                                                ) }}">
                                </div>
                                <div class="form-group">
