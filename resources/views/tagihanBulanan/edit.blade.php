                            ...
                            <form action="{{ route('updateTagihan', ['id' => $tagihan->id_tB]) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_tagihan" id="nama_tagihan" class="form-control"
                                        required='required' placeholder="Masukkan Nama tagihan" value="{{ old('nama_tagihan', $tagihan->nama_tagihan) }}">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Tanggal Tagihan</label>
                                    <input type="date" name="awal_tagihan" id="awal_tagihan" class="form-control"
                                        required='required' placeholder="Masukkan Tanggal tagihan" value="{{ old('awal_tagihan', $tagihan->awal_tagihan) }}">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Jatuh Tempo</label>
                                    <input type="date" name="akhir_tagihan" id="akhir_tagihan" class="form-control"
                                        required='required' placeholder="Masukkan Jatuh Tempo" value="{{ old('akhir_tagihan', $tagihan->akhir_tagihan) }}">
                                 </div>
                                <div class="form-group">
                                    <label for="nama">Jumlah</label>
                                    <input type="number" name="jumlah" id="jumlah" class="form-control"
                                        required='required' placeholder="Masukkan Jumlah Tagihan" value="{{ old('jumlah', $tagihan->jumlah) }}">
                                </div>

                                <div class="form-group">
                                    <label for="nama">Status Tagihan</label>
                                    <select class="form-control" name="status" id="status" required="required" value="{{ old('status', $tagihan->status) }}">
