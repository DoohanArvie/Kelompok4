        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Sumber Pemasukan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container mt-5">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('updateSumberPemasukan', ['id' => $sumber->id_sumber]) }}" method="post">
                                @csrf
                                ...
                                <div class="text-right">
                                    <a href="{{ route('daftarSumberPemasukan') }}" class="btn btn-outline-secondary mr-2"
                                        role="button">Batal</a>
