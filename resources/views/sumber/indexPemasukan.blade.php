        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Sumber Pemasukan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6 ">
                            ...
                            <div class="container mt-5">
                                <div class="card">
                                    <div class="card-header text-right">
                                        <a href="{{ route('createSumberPemasukan') }}" class="btn btn-success"
                                            role="button">Tambah Sumber Pemasukan</a>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="confirmDelete(this)"
                                                                data-url="{{ route('deleteSumberPemasukan', ['id' => $sumber->id_sumber]) }}"class="btn btn-danger btn-sm text-white " style="cursor:pointer; z-index:999">Hapus</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
