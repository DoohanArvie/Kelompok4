...
<head>
  ...
  <title>{{ $title ?? "Melbyu" }} | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ $title ?? "Melbyu" }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('assets/dist/img/melby.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          @auth
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('daftarKategori')}}" class="nav-link active">
                  ...
                  <p>Daftar Kategori Mobil</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('daftarArtikel')}}" class="nav-link">
                  <i class="nav-icon fas fa-store"></i>
                  <p>Daftar Mobil Yang Tersedia</p>
                </a>
              </li>
            </ul>
          </li>
