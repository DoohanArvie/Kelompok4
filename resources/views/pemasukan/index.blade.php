                                ...
                                <div class="container mt-5">
                                    <div class="card">
                                        <div class="card-header text-right">
                                            <a href="{{ route('createPemasukan') }}" class="btn btn-success"
                                                role="button">Tambah Pemasukan</a>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="confirmDelete(this)"
                                                                data-url="{{ route('deletePemasukan', ['id' => $pemasukan->id_pemasukan]) }}"class="btn btn-danger btn-sm text-white " style="cursor:pointer; z-index:999">Hapus</a>
                                                        </td>
